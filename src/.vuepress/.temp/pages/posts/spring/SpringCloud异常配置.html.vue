<template><div><p css-module=".">1.【强制】Java 类库中定义的可以通过预检查方式规避的 RuntimeException 异常不应该通过catch 的方式来处理，比如:NullPointerException，IndexOutOfBoundsException 等等。<br>
...
<p css-module=".">13.【参考】避免出现重复的代码(Don’t Repeat Yourself)，即DRY原则。<br>
