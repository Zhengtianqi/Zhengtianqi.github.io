import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as r,c as t,b as s,d as a,e,a as o}from"./app-26f2803c.js";const l={},c=s("p",null,"本文介绍了redis安装",-1),d=s("h1",{id:"一、下载",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#一、下载","aria-hidden":"true"},"#"),a(" 一、下载")],-1),u=s("br",null,null,-1),v={href:"https://redis.io/download",target:"_blank",rel:"noopener noreferrer"},k=s("br",null,null,-1),m={href:"http://download.redis.io/releases/",target:"_blank",rel:"noopener noreferrer"},b=o(`<div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>解压
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="恢复使用主库redis" tabindex="-1"><a class="header-anchor" href="#恢复使用主库redis" aria-hidden="true">#</a> 恢复使用主库Redis</h2><p>当redis-master服务器出现故障，虚拟IP自动漂移到redis-backup服务器上时，此时禅道相关的session<br> 信息会存储到redis-backup服务器上的redis中，上传的非结构数据也会存储到redis-backup服务器上<br> 的nfs共享目录中。<br> 因为上述步骤测试redis-backup服务器上的redis是否会升级为主库，虚拟IP已转移，所以此步骤可恢复<br> 虚拟IP绑定在redis-master服务器上。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code># 在redis<span class="token operator">-</span>backup服务器上，停止运行keepalived和redis服务
systemctl stop keepalived
systemctl stop redis
...
systemctl start keepalived
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,48);function h(g,_){const n=i("ExternalLinkIcon");return r(),t("div",null,[c,d,s("p",null,[a("官网下载需要安装版本redis，下载地址"),u,s("a",v,[a("https://redis.io/download"),e(n)]),k,s("a",m,[a("http://download.redis.io/releases/"),e(n)]),a(" (所有版本)")]),b])}const j=p(l,[["render",h],["__file","软件安装及高可用部署-四.html.vue"]]);export{j as default};
