...
<p>​	先看看GET和POST的样貌：</p>
<h2 id="get请求" tabindex="-1"><a class="header-anchor" href="#get请求" aria-hidden="true">#</a> GET请求</h2>
...
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Accept 浏览器支持的类型<br>
Accept-Language 浏览器支持的语言<br>
Accept-Encoding 浏览器支持的压缩格式<br>
Host 请求的主机<br>
Connection keep-alive 这个是链接一小段时间</p>
<h2 id="get响应" tabindex="-1"><a class="header-anchor" href="#get响应" aria-hidden="true">#</a> GET响应</h2>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token constant">HTTP</span><span class="token operator">/</span><span class="token number">1.1</span> <span class="token number">200</span> <span class="token constant">OK</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>响应行 (协议/版本 状态码 状态码解析)</p>
<p>响应头 （key/value格式）</p>
<p>空行</p>
<p>响应正文</p>
<h2 id="post请求" tabindex="-1"><a class="header-anchor" href="#post请求" aria-hidden="true">#</a> POST请求</h2>
...
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Content-Type 使用application/x-www-form-urlencoded</p>
<p>转化为字节 -- 加上128 -- 转化为16进制 -- 添加%</p>
<h2 id="post响应" tabindex="-1"><a class="header-anchor" href="#post响应" aria-hidden="true">#</a> POST响应</h2>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token constant">POST</span> <span class="token operator">/</span>index<span class="token punctuation">.</span>jsp <span class="token constant">HTTP</span><span class="token operator">/</span><span class="token number">1.1</span>
<span class="token class-name">Host</span><span class="token operator">:</span> localhost<span class="token operator">:</span><span class="token number">8088</span>
<span class="token class-name">Connection</span><span class="token operator">:</span> keep<span class="token operator">-</span>alive
...
sdfdsfsdfdsf
------WebKitFormBoundarySN8ehdkx6tF3Ngiq--
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_2、w3c表格对比" tabindex="-1"><a class="header-anchor" href="#_2、w3c表格对比" aria-hidden="true">#</a> 2、W3C表格对比</h1>
<figure><img src="/assets/images/GETPOST.png" alt="image-20200721091103941" tabindex="0" loading="lazy"><figcaption>image-20200721091103941</figcaption></figure>
<h2 id="_1-表格对比" tabindex="-1"><a class="header-anchor" href="#_1-表格对比" aria-hidden="true">#</a> （1）表格对比：</h2>
<p>​		GET 用于获取信息，是无副作用的，是幂等的，且可缓存<br>
​		POST 用于修改服务器上的数据，有副作用，非幂等，不可缓存</p>
<p>​		幂等性：是指无论调用多少次都不会有不同结果的一种特性，一般是指HTTP GET的查询方法。</p>
<h2 id="_2-交互对比" tabindex="-1"><a class="header-anchor" href="#_2-交互对比" aria-hidden="true">#</a> （2）交互对比</h2>
...
<h1 id="_3、面试问题" tabindex="-1"><a class="header-anchor" href="#_3、面试问题" aria-hidden="true">#</a> 3、面试问题</h1>
<h2 id="_1-get方法的参数写法是固定的吗" tabindex="-1"><a class="header-anchor" href="#_1-get方法的参数写法是固定的吗" aria-hidden="true">#</a> （1）GET方法的参数写法是固定的吗？</h2>
...
<h2 id="_2-get-方法的长度限制是怎么回事" tabindex="-1"><a class="header-anchor" href="#_2-get-方法的长度限制是怎么回事" aria-hidden="true">#</a> （2）GET 方法的长度限制是怎么回事？</h2>
...
<h2 id="_3-post-方法比-get-方法安全" tabindex="-1"><a class="header-anchor" href="#_3-post-方法比-get-方法安全" aria-hidden="true">#</a> （3）POST 方法比 GET 方法安全？</h2>
...
<p>参考：<a href="http://www.javanx.cn/20190227/get-post/" target="_blank" rel="noopener noreferrer">http://www.javanx.cn/20190227/get-post/<ExternalLinkIcon/></a></p>
<h2 id="_4-post-方法会产生两个-tcp-数据包" tabindex="-1"><a class="header-anchor" href="#_4-post-方法会产生两个-tcp-数据包" aria-hidden="true">#</a> （4）POST 方法会产生两个 TCP 数据包？</h2>
