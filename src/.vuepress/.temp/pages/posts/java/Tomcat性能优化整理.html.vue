<template><div><h1 id="_1、jvm参数调优" tabindex="-1"><a class="header-anchor" href="#_1、jvm参数调优" aria-hidden="true">#</a> 1、JVM参数调优</h1>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token operator">-</span><span class="token class-name">Xms</span><span class="token generics"><span class="token punctuation">&lt;</span>size<span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>表示JVM初始化堆的大小</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token operator">-</span><span class="token class-name">Xmx</span><span class="token generics"><span class="token punctuation">&lt;</span>size<span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>表示JVM堆的最大值</p>
...
<h1 id="_2、禁用dns查询" tabindex="-1"><a class="header-anchor" href="#_2、禁用dns查询" aria-hidden="true">#</a> 2、禁用DNS查询</h1>
...
<h1 id="_3、调整线程数" tabindex="-1"><a class="header-anchor" href="#_3、调整线程数" aria-hidden="true">#</a> 3、调整线程数</h1>
...
<h1 id="_4、加大tomcat内存" tabindex="-1"><a class="header-anchor" href="#_4、加大tomcat内存" aria-hidden="true">#</a> 4、加大Tomcat内存</h1>
<p>​		首先检查程序有没有限入死循环<br>
