<template><div><h1 id="_1、什么是重构" tabindex="-1"><a class="header-anchor" href="#_1、什么是重构" aria-hidden="true">#</a> 1、什么是重构</h1>
...
<h1 id="_2、软件质量因素的定义" tabindex="-1"><a class="header-anchor" href="#_2、软件质量因素的定义" aria-hidden="true">#</a> 2、软件质量因素的定义</h1>
...
<h1 id="_3、重构的意义" tabindex="-1"><a class="header-anchor" href="#_3、重构的意义" aria-hidden="true">#</a> 3、重构的意义</h1>
...
<h1 id="_4、重构实例演示" tabindex="-1"><a class="header-anchor" href="#_4、重构实例演示" aria-hidden="true">#</a> 4、重构实例演示</h1>
...
<figure><img src="/assets/images/1618675966507.png" alt="1618675966507" tabindex="0" loading="lazy"><figcaption>1618675966507</figcaption></figure>
<figure><img src="/assets/images/1618675987731.png" alt="1618675987731" tabindex="0" loading="lazy"><figcaption>1618675987731</figcaption></figure>
<figure><img src="/assets/images/1618676025236.png" alt="1618676025236" tabindex="0" loading="lazy"><figcaption>1618676025236</figcaption></figure>
<p>存在的问题：</p>
...
<h2 id="step1、重构第一步-可靠的测试" tabindex="-1"><a class="header-anchor" href="#step1、重构第一步-可靠的测试" aria-hidden="true">#</a> Step1、重构第一步-可靠的测试</h2>
<p>01 进行重构时，我们需要依赖测试，让它告诉我们是否引入bug。好的测试是重构的根本</p>
<p>02 重构的前提是要有一个可靠的测试，这个测试必须有自我检验能力</p>
<h2 id="step2、重构第二步-分解重组statement-找出代码的逻辑泥团并运用extract-method" tabindex="-1"><a class="header-anchor" href="#step2、重构第二步-分解重组statement-找出代码的逻辑泥团并运用extract-method" aria-hidden="true">#</a> Step2、重构第二步-分解重组statement 找出代码的逻辑泥团并运用Extract Method</h2>
...
<figure><img src="/assets/images/1618676190337.png" alt="1618676190337" tabindex="0" loading="lazy"><figcaption>1618676190337</figcaption></figure>
<h2 id="step3、重构第三步-更改amountfor中的变量名" tabindex="-1"><a class="header-anchor" href="#step3、重构第三步-更改amountfor中的变量名" aria-hidden="true">#</a> Step3、重构第三步-更改amountFor中的变量名</h2>
...
<figure><img src="/assets/images/1618676232016.png" alt="1618676232016" tabindex="0" loading="lazy"><figcaption>1618676232016</figcaption></figure>
<h2 id="step4、重构第四步-搬移金额计算代码" tabindex="-1"><a class="header-anchor" href="#step4、重构第四步-搬移金额计算代码" aria-hidden="true">#</a> Step4、重构第四步-搬移金额计算代码</h2>
...
<figure><img src="/assets/images/1618676280257.png" alt="1618676280257" tabindex="0" loading="lazy"><figcaption>1618676280257</figcaption></figure>
<p>第一步：先将计算金额代码搬移到Rental类中</p>
<p>Rental类中添加方法 getCharge</p>
<p>第二步：针对搬移后的代码，调整Consumer类</p>
<h2 id="step5、重构第五步-运用extract-method-参考抽取计算金额-来抽取积分" tabindex="-1"><a class="header-anchor" href="#step5、重构第五步-运用extract-method-参考抽取计算金额-来抽取积分" aria-hidden="true">#</a> Step5、重构第五步-运用Extract Method 参考抽取计算金额，来抽取积分</h2>
<figure><img src="/assets/images/1618676358941.png" alt="1618676358941" tabindex="0" loading="lazy"><figcaption>1618676358941</figcaption></figure>
<p>第一步：将积分计算方法搬移到Rental类中</p>
<p>第二步：2、更改consumer类中获取积分</p>
<h2 id="step6、重构第六步-去掉临时变量" tabindex="-1"><a class="header-anchor" href="#step6、重构第六步-去掉临时变量" aria-hidden="true">#</a> Step6、重构第六步-去掉临时变量</h2>
...
<figure><img src="/assets/images/1618676411155.png" alt="1618676411155" tabindex="0" loading="lazy"><figcaption>1618676411155</figcaption></figure>
<p>第一步：totalAmount和frequenRenterPoint两个临时变量</p>
<p>第二步：使用查询函数来替代</p>
<h2 id="step7、重构第七步-运用多态取代与价格相关的条件逻辑" tabindex="-1"><a class="header-anchor" href="#step7、重构第七步-运用多态取代与价格相关的条件逻辑" aria-hidden="true">#</a> Step7、重构第七步-运用多态取代与价格相关的条件逻辑</h2>
...
<figure><img src="/assets/images/1618676461026.png" alt="1618676461026" tabindex="0" loading="lazy"><figcaption>1618676461026</figcaption></figure>
<h2 id="step8、重构第八步-运用多态取代与价格相关的条件逻辑" tabindex="-1"><a class="header-anchor" href="#step8、重构第八步-运用多态取代与价格相关的条件逻辑" aria-hidden="true">#</a> Step8、重构第八步-运用多态取代与价格相关的条件逻辑</h2>
...
<figure><img src="/assets/images/1618676506490.png" alt="1618676506490" tabindex="0" loading="lazy"><figcaption>1618676506490</figcaption></figure>
<figure><img src="/assets/images/1618676526483.png" alt="1618676526483" tabindex="0" loading="lazy"><figcaption>1618676526483</figcaption></figure>
...
<h1 id="_6、重构的时机" tabindex="-1"><a class="header-anchor" href="#_6、重构的时机" aria-hidden="true">#</a> 6、重构的时机</h1>
<h2 id="_1-、什么时候重构" tabindex="-1"><a class="header-anchor" href="#_1-、什么时候重构" aria-hidden="true">#</a> （1）、什么时候重构</h2>
<p>三次法则：事不过三，三则重构<br>
...
<h2 id="_2-、什么时候不重构" tabindex="-1"><a class="header-anchor" href="#_2-、什么时候不重构" aria-hidden="true">#</a> （2）、什么时候不重构</h2>
<p>既有代码太混乱，且不能正常工作，需要重写而不是重构。<br>
项目接近最后期限时，应该避免重构。</p>
<h1 id="_7、重构的手段" tabindex="-1"><a class="header-anchor" href="#_7、重构的手段" aria-hidden="true">#</a> 7、重构的手段</h1>
<h2 id="_1-、改善重复代码" tabindex="-1"><a class="header-anchor" href="#_1-、改善重复代码" aria-hidden="true">#</a> （1）、改善重复代码</h2>
...
<h2 id="_2-、改善过长的函数、过大的类、-过长的参数列" tabindex="-1"><a class="header-anchor" href="#_2-、改善过长的函数、过大的类、-过长的参数列" aria-hidden="true">#</a> （2）、改善过长的函数、过大的类、 过长的参数列</h2>
...
<h2 id="_3-、发散式变化" tabindex="-1"><a class="header-anchor" href="#_3-、发散式变化" aria-hidden="true">#</a> （3）、发散式变化</h2>
...
<h2 id="_4-、霾弹式修改" tabindex="-1"><a class="header-anchor" href="#_4-、霾弹式修改" aria-hidden="true">#</a> （4）、霾弹式修改</h2>
...
<h2 id="_5-、-依恋情节" tabindex="-1"><a class="header-anchor" href="#_5-、-依恋情节" aria-hidden="true">#</a> （5）、 依恋情节</h2>
...
<h2 id="_6-、数据泥团" tabindex="-1"><a class="header-anchor" href="#_6-、数据泥团" aria-hidden="true">#</a> （6）、数据泥团</h2>
...
<h2 id="_7-、基本类型偏执" tabindex="-1"><a class="header-anchor" href="#_7-、基本类型偏执" aria-hidden="true">#</a> （7）、基本类型偏执</h2>
...
<h2 id="_8-、switch惊悚现身" tabindex="-1"><a class="header-anchor" href="#_8-、switch惊悚现身" aria-hidden="true">#</a> （8）、Switch惊悚现身</h2>
...
<h2 id="_9-、平行继承体系" tabindex="-1"><a class="header-anchor" href="#_9-、平行继承体系" aria-hidden="true">#</a> （9）、平行继承体系</h2>
...
<figure><img src="/assets/images/1618677203153.png" alt="1618677203153" tabindex="0" loading="lazy"><figcaption>1618677203153</figcaption></figure>
<h2 id="_10-、冗赘类" tabindex="-1"><a class="header-anchor" href="#_10-、冗赘类" aria-hidden="true">#</a> （10）、冗赘类</h2>
...
<h2 id="_11-、夸夸其谈未来性" tabindex="-1"><a class="header-anchor" href="#_11-、夸夸其谈未来性" aria-hidden="true">#</a> （11）、夸夸其谈未来性</h2>
...
<h2 id="_12-、令人迷惑的暂时字段" tabindex="-1"><a class="header-anchor" href="#_12-、令人迷惑的暂时字段" aria-hidden="true">#</a> （12）、令人迷惑的暂时字段</h2>
...
<h2 id="_13-、-过度耦合的消息链" tabindex="-1"><a class="header-anchor" href="#_13-、-过度耦合的消息链" aria-hidden="true">#</a> （13）、 过度耦合的消息链</h2>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> result<span class="token operator">=</span><span class="token class-name">Class</span><span class="token punctuation">.</span><span class="token function">getFile</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">getFileChannel</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">getFileSource</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">getFileName</span><span class="token punctuation">(</span><span class="token punctuation">)</span> 

<span class="token class-name">String</span> result<span class="token operator">=</span><span class="token class-name">Class</span><span class="token punctuation">.</span><span class="token function">getFile</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">getFileName</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​		常常是因为数据结构的层次很深，需要层层调用getter获取内层数据。 个人认为Message Chains如果频繁出现，考虑这个字段是否应该移到较外层的类，或者把调用链封装在较外层类的方法。</p>
<h2 id="_14-、中间人" tabindex="-1"><a class="header-anchor" href="#_14-、中间人" aria-hidden="true">#</a> （14）、中间人</h2>
...
<h2 id="_15-、狎昵关系" tabindex="-1"><a class="header-anchor" href="#_15-、狎昵关系" aria-hidden="true">#</a> （15）、狎昵关系</h2>
