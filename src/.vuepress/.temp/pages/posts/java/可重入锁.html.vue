<template><div><h2 id="_1、可重入锁" tabindex="-1"><a class="header-anchor" href="#_1、可重入锁" aria-hidden="true">#</a> 1、可重入锁：</h2>
...
<h2 id="_2、synchronized和reentrantlock" tabindex="-1"><a class="header-anchor" href="#_2、synchronized和reentrantlock" aria-hidden="true">#</a> 2、Synchronized和ReentrantLock</h2>
