import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as e}from"./app-26f2803c.js";const p={},o=e(`<p>本文介绍了Nginx安装</p><h1 id="一、修改主机名" tabindex="-1"><a class="header-anchor" href="#一、修改主机名" aria-hidden="true">#</a> 一、修改主机名</h1><p>以 nginx-master 为例，修改所有服务器的对应的主机名。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>vim <span class="token operator">/</span>etc<span class="token operator">/</span>hostname
# 删除所有的内容，修改为要修改的主机名
nginx01
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="三、修改环境变量" tabindex="-1"><a class="header-anchor" href="#三、修改环境变量" aria-hidden="true">#</a> 三、修改环境变量</h1><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>vim <span class="token operator">/</span>root<span class="token operator">/</span><span class="token punctuation">.</span>bash_profile
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="四、验证可用" tabindex="-1"><a class="header-anchor" href="#四、验证可用" aria-hidden="true">#</a> 四、验证可用</h1><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code># 在任意位置输入，先停止<span class="token class-name">Nginx</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="五、在nginx-backup服务器上重复以上步骤-安装nginx。" tabindex="-1"><a class="header-anchor" href="#五、在nginx-backup服务器上重复以上步骤-安装nginx。" aria-hidden="true">#</a> 五、在nginx-backup服务器上重复以上步骤，安装Nginx。</h1><h1 id="六、nginx高可用配置" tabindex="-1"><a class="header-anchor" href="#六、nginx高可用配置" aria-hidden="true">#</a> 六、Nginx高可用配置</h1><h2 id="nginx-master配置" tabindex="-1"><a class="header-anchor" href="#nginx-master配置" aria-hidden="true">#</a> nginx-master配置</h2><p>在nginx-master服务器上修改keepalived配置文件。注意配置中interface(指定网卡)、virtual_ipaddress(虚拟IP)、unicast_src_ip(本机IP)和unicast_peer(其它服务器IP)参数可根据实际环境进行配置。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>vim <span class="token operator">/</span>etc<span class="token operator">/</span>keepalived<span class="token operator">/</span>keepalived<span class="token punctuation">.</span>conf
# 将原配置文件内容清空，添加以下配置内容↓：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="在nginx-master服务器上验证虚拟ip是否绑定。" tabindex="-1"><a class="header-anchor" href="#在nginx-master服务器上验证虚拟ip是否绑定。" aria-hidden="true">#</a> 在nginx-master服务器上验证虚拟IP是否绑定。</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>chmod <span class="token operator">-</span><span class="token class-name">R</span> <span class="token number">777</span> <span class="token operator">/</span>etc<span class="token operator">/</span>keepalived<span class="token operator">/</span>keepalived<span class="token punctuation">.</span>conf
service keepalived stop
service keepalived start
# 查看虚拟<span class="token constant">IP</span>是否出现在了网卡上
ip a
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="nginx-backup配置" tabindex="-1"><a class="header-anchor" href="#nginx-backup配置" aria-hidden="true">#</a> nginx-backup配置</h2><p>在nginx-backup服务器上修改keepalived配置文件。注意配置中interface(指定网卡)、virtual_ipaddress(虚拟IP)、unicast_src_ip(本机IP)和unicast_peer(其它服务器IP)参数可根据实际环境进行配置。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>vim <span class="token operator">/</span>etc<span class="token operator">/</span>keepalived<span class="token operator">/</span>keepalived<span class="token punctuation">.</span>conf
# 将原配置文件内容清空，添加以下配置内容↓：
<span class="token operator">!</span> <span class="token class-name">Configuration</span> <span class="token class-name">File</span> <span class="token keyword">for</span> keepalived
vrrp_script check_nginx <span class="token punctuation">{</span>
  script <span class="token string">&quot;/usr/local/keepalived/sbin/check_nginx.sh&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="在nginx-backup服务器上验证虚拟ip是否绑定。" tabindex="-1"><a class="header-anchor" href="#在nginx-backup服务器上验证虚拟ip是否绑定。" aria-hidden="true">#</a> 在nginx-backup服务器上验证虚拟IP是否绑定。</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>chmod <span class="token operator">-</span><span class="token class-name">R</span> <span class="token number">777</span> <span class="token operator">/</span>etc<span class="token operator">/</span>keepalived<span class="token operator">/</span>keepalived<span class="token punctuation">.</span>conf
service keepalived stop
service keepalived start
...
ip a
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,30),i=[o];function t(r,l){return s(),a("div",null,i)}const u=n(p,[["render",t],["__file","软件安装及高可用部署-二.html.vue"]]);export{u as default};
