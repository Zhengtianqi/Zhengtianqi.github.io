<template><div><h2 id="_1、轻量级锁" tabindex="-1"><a class="header-anchor" href="#_1、轻量级锁" aria-hidden="true">#</a> 1、轻量级锁</h2>
...
<h2 id="_2、锁消除" tabindex="-1"><a class="header-anchor" href="#_2、锁消除" aria-hidden="true">#</a> 2、锁消除</h2>
...
<h2 id="_3、锁膨胀" tabindex="-1"><a class="header-anchor" href="#_3、锁膨胀" aria-hidden="true">#</a> 3、锁膨胀</h2>
